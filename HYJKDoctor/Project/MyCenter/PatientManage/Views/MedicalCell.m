...
+ (instancetype)medicalCell
{
    ...
    cell.titleLabel.textColor = RGB(100, 100, 100, 1);
...
- (void)layoutSubviews
{
    ...
    self.titleLabel.frame = CGRectMake((15),0,(150),self.height);
    self.detailLabel.frame = CGRectMake(self.titleLabel.right,0, self.width - self.titleLabel.right - 30, self.height);
    self.line.frame = CGRectMake((15), self.titleLabel.bottom - 1, ScreenWidth - (15), 1);
...
- (void)setDetailStr:(NSString *)detailStr
{
    if (detailStr.length < 1 || [detailStr isEqualToString:@"未填写"]) {
        ...
        self.detailLabel.textColor = RGB(220, 220, 200, 1);
        return;
    }
