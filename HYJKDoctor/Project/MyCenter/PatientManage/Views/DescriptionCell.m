...
+ (instancetype)descriptionCellWithTitle:(NSString *)title andPlaceHolder:(NSString *)palceHolder
{
    ...
    textView.textColor = RGB(220, 220, 220, 1);
...
- (void)layoutSubviews
{
    ...
    self.titleLabel.frame = CGRectMake((15), 0, ScreenWidth - (15),44);
    self.textView.frame = CGRectMake((10), self.titleLabel.bottom, ScreenWidth - (20), 145 - self.titleLabel.height );
}
...
- (void)setDescriptionStr:(NSString *)descriptionStr
{
    ...
    if (descriptionStr.length < 1 || [descriptionStr isEqualToString:self.placeHolder]) {
        ...
        self.textView.textColor = RGB(220, 220, 220, 1);
    }
