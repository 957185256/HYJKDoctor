...
- (void)showView:(UIView *)popupView overlayView:(UIView *)overlayView{
    ...
    /**
     *  调用处使用以下方法 写以下要pop出来的位置
     [_menuView qzSetAssociatedObject:@"1" forKey:@"isCustomFrame"];
     [_menuView qzSetAssociatedObject:NSStringFromCGRect(_menuView.frame) forKey:@"customFrame"];
     
     */
//    if ([[popupView qzAssociatedObjectForKey:@"isCustomFrame"] isEqualToString:@"1"]) {
//        popupEndRect = CGRectFromString([popupView qzAssociatedObjectForKey:@"customFrame"]);
//        
//    }
